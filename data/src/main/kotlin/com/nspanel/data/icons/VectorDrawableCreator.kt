@file:Suppress("MagicNumber", "LongMethod", "TooGenericExceptionCaught")
...
/**
 * Taken from https://stackoverflow.com/questions/33312157/create-vectordrawable-from-string-path
 */
object VectorDrawableCreator {
    ...
    fun getVectorDrawable(
        ...
        val binXml = createBinaryDrawableXml(width.value.toInt(), height.value.toInt(), viewportWidth, viewportHeight, paths)
        try {
